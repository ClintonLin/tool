@echo off
title 传包神器 Created by xudachao
...
:: set serch_path="/home/app1 ${APP2_HOME}"
...
echo 查找并替换软件包：
echo =======================================================================
tools\plink.exe -pw %passwd% %user%@%ip% "bash %backupPathRemote%/replace_package.sh %serch_path% | tee -a %backupPathRemote%/replace_package.log"
echo.
